...
const options8 = {
    targetClass: "lead3",
    text: "Welcome to Lugo, your digital powerhouse. Elevate with strategic marketing, cutting-edge web development, and dynamic branding. Amplify your online presence and craft a compelling identity. Let's achieve success together – connect for a tailored consultation today.",
    delay: 10,
    cursorSpeed: 900
};
const options9 = {
    targetClass: "service-title",
    text: "Fusing creativity to build extraordinary brands.",
    delay: 80,
    cursorSpeed: 900
};
